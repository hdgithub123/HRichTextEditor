...
import { _FONTFAMILY, _FONTSIZES,_COMMONCOLOURS } from '../../_constant/_constant';

export const COLORS = _COMMONCOLOURS ? Object.values(_COMMONCOLOURS) : [
...
const customStyleMap = ({ colors, fonts, fontSizes }) => {
  const styleMap = { ...DefaultDraftInlineStyle };


  let colorsList = Object.values(_COMMONCOLOURS);
