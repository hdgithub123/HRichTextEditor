...
// Chinh sua table Shape trước khi đưa data vào ( nhân bản các {{tableID.field}} trước khi thay doi chu)
const changeEditorStateWithRowSpan = ({ contentState, tableData, tableKey }) => {
